...
const Tab = ({ text, selected, setSelected, icon }: TabProps) => {
  return (
    <button
      ...
      } relative rounded-md px-3 py-2 text-sm font-medium transition-colors flex items-center gap-2 min-h-[44px]`}
    >
...
export const AnimatedTabs = ({ tabs, selected, onTabChange, className = '' }: AnimatedTabsProps) => {
  return (
