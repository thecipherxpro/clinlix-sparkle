...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F8FAFC] to-[#CFE9F5] flex flex-col items-center justify-between px-6 py-8 overflow-hidden">
      {/* Cleaning Lady Image */}
      <div 
      ...
      {/* Security Footer */}
      <div 
        className={`text-center pb-4 transition-all duration-800 ${
          showContent ? 'opacity-100' : 'opacity-0'
        }`}
        style={{ transitionDelay: '1500ms' }}
      >
        <p className="text-[10px] text-[#007B67] font-medium">
