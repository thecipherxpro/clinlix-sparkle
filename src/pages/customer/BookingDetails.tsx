  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/10 to-background pb-6">
      ...
      <main className="mobile-container py-4 sm:py-6 max-w-4xl space-y-3 sm:space-y-4 pb-16">
        ...
        <Card className="border-0 shadow-sm rounded-xl">
          ...
          <CardContent className="space-y-4 p-4 sm:p-6 pt-3">
            ...
            <div className="flex justify-center sm:justify-start">
              <div
                className={`badge ${booking.payment_status === "paid" ? "badge-success text-white" : "badge-warning text-white"} border-0 shadow-md px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold`}
              >
        ...
        {/* Actions */}
        {canCancel && (
          <Card className="border-0 shadow-sm border-destructive/20 rounded-xl">
